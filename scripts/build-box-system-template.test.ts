...
describe("Box system template builder", () => {
  ...
  test("constructs a fixed CLI installation with no provider credentials or service", () => {
    ...
    expect(command).toContain("sudo -n env WORKSPACE_ROOT=/home/user/workspace")
    ...
    expect(command).toContain("cd /home/user/workspace")
    expect(command).toContain('install -d -m 0755 -o "$(id -u)" -g "$(id -g)" /home/user/workspace')
